 ...
 */
@Experimental
public interface AlignmentAwareSplitReader<E, SplitT extends SourceSplit>
        extends SplitReader<E, SplitT> {
    /**
     * Align the watermarks of splits by temporarily halt consumption of the some splits and resume
