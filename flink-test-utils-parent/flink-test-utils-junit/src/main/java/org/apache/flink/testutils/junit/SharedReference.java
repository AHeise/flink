...
/**
 * Represents an object managed in a {@link SharedObjects}. The reference can serialized and will
 * still point to the same instance after deserialization in the same JVM. The underlying object
 * may change the state but this reference will never point to another object.
 *
