...
dependencies {
    ...
    testImplementation(Libs.curator_test version stringProperty("curator.version"))
    testImplementation(Libs.scalatest)
    testImplementation(Libs.okhttp version "3.7.0")
