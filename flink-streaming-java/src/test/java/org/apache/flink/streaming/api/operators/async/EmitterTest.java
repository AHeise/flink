...
public class EmitterTest extends TestLogger {
	...
	private static class MockExecutor implements MailboxExecutor {
		@Override public void execute(@Nonnull Runnable command) throws RejectedExecutionException {
			executor.execute(command);
		}

		@Override public void yield() throws InterruptedException, IllegalStateException {
			throw new UnsupportedOperationException();
		}

		@Override public boolean tryYield() throws IllegalStateException {
			throw new UnsupportedOperationException();
		}

		@Override public boolean isMailboxThread() {
			return true;
		}
	}
}
